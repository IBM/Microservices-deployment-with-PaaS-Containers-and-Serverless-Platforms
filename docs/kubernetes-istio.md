...
| [ingress.yaml](https://github.com/IBM/Microservices-deployment-with-PaaS-Containers-and-Serverless-Platforms/ingress.yaml)| Specification file for adding flightassist's endpoint to istio-ingress| 
| [ratelimit.yaml](https://github.com/IBM/Microservices-deployment-with-PaaS-Containers-and-Serverless-Platforms/ratelimit.yaml) | Specification file for creating rate limits with Istio Mixer| 